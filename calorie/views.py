...
from .forms import SelectFoodForm,AddFoodForm,CreateUserForm,ProfileForm,UpdateProfileForm,UserRegisterForm
from .models import *
...
def update_profile(request,id):
    ...
    profile = Profile.objects.get(person_of_id = user)
